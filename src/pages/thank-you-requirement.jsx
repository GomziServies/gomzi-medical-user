...
function RequirementThankYouPage() {
  return (
    <>
      <Helmet>
            ...
            <div className="row">
              <div className="wrapper-1">
                <div className="wrapper-2">
                  ...
                  <p class="message">
                    Your requested product information has been successfully
                    sent. Our team will contact you shortly to confirm the
                    details.
                  </p>
...
export default RequirementThankYouPage;
