                            ...
                            <div className="col-lg-7 d-flex align-items-center mt-md-0 p-0">
                                <div className="inner-shop-details-content">
                                    <div className="bg-product px-3 pb-3 pt-3">
                                        ...
                                        <p className="pt-4">
                                            IGF-1 LR3 (Insulin-like Growth
                                            Factor-1 Long Arg3) is a synthetic
                                            peptide hormone with an extended
                                            half-life, designed to mimic and
                                            enhance the effects of natural
                                            IGF-1. It plays a major role in
                                            muscle growth, cell repair, and fat
                                            loss, making it popular in
                                            ...
                                            <div>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        hyperplasia (new cell
                                                        growth)
                                                    </li>
                                                    <li>
                                                        Enhances insulin
                                                        sensitivity (with proper
                                                        diet)
                                                    </li>
                                                </ul>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        Off-cycle: Equal time
                                                        off (e.g., 6 weeks on, 6
                                                        weeks off)
                                                    </li>
                                                    <li>
                                                        Monitoring: Track blood
                                                        glucose and IGF-1 if
                                                        extended use
                                                    </li>
                                                </ul>
                                                ...
                                                <p className="mt-5">
                                                    IGF-1 LR3 is one of the most
                                                    powerful anabolic and
                                                    regenerative peptides
                                                    available. Its long
                                                    duration, potent growth
                                                    signaling, and
                                                    muscle-rebuilding
                                                    capabilities make it ideal
                                                    for serious bodybuilders and
                                                    athletes. With proper dosing
                                                    and careful carb management,
                                                    users can experience
                                                    accelerated progress — but
                                                    caution and cycle control
